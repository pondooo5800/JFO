...
class OverviewAppBackground extends Component {
    render() {
        return (
                    ...
                    <View style={{flex: 1}} >
                        <View style={{paddingHorizontal: 25, paddingVertical: 15}}>
                            <Text style={{color: '#000', fontFamily: Fonts.SukhumvitSetSemiBold, fontSize: 18}}>
                                รายงานสถิติการใช้งานโมบายแอพพลิเคชั่น
                                </Text>
...
export default class OverviewAppScreen extends Component {
    render() {
        return (
            <OverviewAppBackground navigation={this.props.navigation} />
        );
    }
}
